...
def getFile():
    file = open('edgelists/LargestComponent_SNAP.txt', 'r')
    return file
...
def getComfortValues():
    ...
    #comfortValues = rand(getNumberOfNodes())
...
def getNodes(num_steps):
    ...
    for player in players:
        ...
        player.comfort = round(comfort*num_steps)/num_steps
